...
<a href="https://travis-ci.org/dod38fr/config-model">
   <img src="https://travis-ci.org/dod38fr/config-model.svg?branch=master">
</a>>
...
For instance, to configure L<ssh|http://man.cx/ssh_config> or
L<C</etc/ssh/sshd_config>|http://man.cx/sshd_config>, you need to
